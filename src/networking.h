...
#define NETMAN_RPC_BLOCK_SIZE_LESSER 24
...
#define IP_MASK(a, b) do {(a).shorts[0] &= (b).shorts[0];(a).shorts[1] &= (b).shorts[1];} while(0)
...
extern unsigned char link_up;

extern hwaddr_t BROADCAST_HWADDR;
extern hwaddr_t NULL_HWADDR;
extern hwaddr_t our_hwaddr;
extern ipaddr_t IP_ANY;
extern ipaddr_t IP_BROADCAST;
extern ipaddr_t our_ip;
